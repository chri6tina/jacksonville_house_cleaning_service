  ...
  return (
    <div className="min-h-screen bg-white">
      <UniversalServiceHero 
        title="Luxury Home Cleaning Services"
        subtitle="Premium cleaning services for Jacksonville's most discerning residents"
        Icon={Sparkles}
        primaryColor="blue"
        formServiceType="luxury-home-cleaning"
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="text-3xl font-bold text-primary-blue mb-4">$250-400</div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border-2 border-primary-blue">
              ...
              <div className="text-3xl font-bold text-primary-blue mb-4">$450-650</div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="text-3xl font-bold text-primary-blue mb-4">$750-1200</div>
