  ...
  return (
    <div className="min-h-screen bg-white">
      <UniversalServiceHero 
        title="Senior Citizen Cleaning Service"
        subtitle="Gentle, accessible cleaning services designed specifically for seniors, with companionship and care that goes beyond just cleaning. Starting at just $100."
        Icon={Sparkles}
        primaryColor="blue"
        formServiceType="senior-citizen-cleaning"
      />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            {process.map((step) => (
              <div key={step.step} className="text-center">
                <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl font-bold text-primary-blue">{step.step}</span>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {specialConsiderations.map((consideration, index) => (
              <div key={index} className="bg-white rounded-2xl shadow-lg p-8">
                <div className="text-center mb-6">
                  <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    <consideration.icon className="w-8 h-8 text-primary-blue" />
                  </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              ...
              className="border-2 border-white text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-white hover:text-primary-blue transition-colors duration-200 flex items-center justify-center space-x-2"
            >
