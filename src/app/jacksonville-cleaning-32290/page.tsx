...
export const metadata: Metadata = buildMetadata({
  title: pageData?.title ?? 'Jacksonville Cleaning 32290',
  description: pageData?.description ?? 'Jacksonville cleaning service information.',
  canonical: `${SITE_CONFIG.url}/jacksonville-cleaning-32290`,
  keywords: ["Jacksonville Cleaning 32290 cleaning","Jacksonville Cleaning 32290 service","Jacksonville cleaning"],
});
