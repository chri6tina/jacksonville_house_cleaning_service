...
export const metadata: Metadata = buildMetadata({
  title: pageData?.title ?? 'Jacksonville Cleaning 32086',
  description: pageData?.description ?? 'Jacksonville cleaning service information.',
  canonical: `${SITE_CONFIG.url}/jacksonville-cleaning-32086`,
  keywords: ["Jacksonville Cleaning 32086 cleaning","Jacksonville Cleaning 32086 service","Jacksonville cleaning"],
});
