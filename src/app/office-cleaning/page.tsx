  ...
  return (
    <div className="min-h-screen bg-white">
      <UniversalServiceHero 
        ...
        subtitle="Keep your Jacksonville business spotless with our professional office cleaning services. Minimal disruption, maximum results."
        Icon={Building2}
        primaryColor="blue"
        formServiceType="office-cleaning"
      />
