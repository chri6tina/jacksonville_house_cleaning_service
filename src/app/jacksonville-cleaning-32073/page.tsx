...
export const metadata: Metadata = buildMetadata({
  title: pageData?.title ?? 'Jacksonville Cleaning 32073',
  description: pageData?.description ?? 'Jacksonville cleaning service information.',
  canonical: `${SITE_CONFIG.url}/jacksonville-cleaning-32073`,
  keywords: ["Jacksonville Cleaning 32073 cleaning","Jacksonville Cleaning 32073 service","Jacksonville cleaning"],
});
