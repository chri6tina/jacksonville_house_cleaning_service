...
export const metadata: Metadata = buildMetadata({
  title: pageData?.title ?? 'Jacksonville Cleaning 32246',
  description: pageData?.description ?? 'Jacksonville cleaning service information.',
  canonical: `${SITE_CONFIG.url}/jacksonville-cleaning-32246`,
  keywords: ["Jacksonville Cleaning 32246 cleaning","Jacksonville Cleaning 32246 service","Jacksonville cleaning"],
});
