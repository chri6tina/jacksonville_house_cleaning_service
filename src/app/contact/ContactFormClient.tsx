        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-blue-600 text-white rounded-lg p-8 text-center">
              ...
              <h3 className="text-2xl font-bold mb-2">Call Now for Immediate Service</h3>
              <p className="text-xl mb-4">(904) 456-3851</p>
            ...
            <div className="bg-white rounded-lg shadow-xl p-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <Phone className="h-6 w-6 text-blue-600 mt-1 mr-3 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-gray-900">Phone</p>
                    <p className="text-gray-600">(904) 456-3851</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@jacksonvillehousecleaningservice.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Jacksonville and surrounding areas</p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-xl p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <p className="text-gray-600">Licensed and insured cleaning professionals</p>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-500 mt-1 mr-3 flex-shrink-0" />
                  <p className="text-gray-600">Eco-friendly cleaning products available</p>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-500 mt-1 mr-3 flex-shrink-0" />
