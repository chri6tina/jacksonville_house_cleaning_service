...
export const metadata: Metadata = buildMetadata({
  title: pageData?.title ?? 'Jacksonville Cleaning 32238',
  description: pageData?.description ?? 'Jacksonville cleaning service information.',
  canonical: `${SITE_CONFIG.url}/jacksonville-cleaning-32238`,
  keywords: ["Jacksonville Cleaning 32238 cleaning","Jacksonville Cleaning 32238 service","Jacksonville cleaning"],
});
