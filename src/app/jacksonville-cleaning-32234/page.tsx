...
export const metadata: Metadata = buildMetadata({
  title: pageData?.title ?? 'Jacksonville Cleaning 32234',
  description: pageData?.description ?? 'Jacksonville cleaning service information.',
  canonical: `${SITE_CONFIG.url}/jacksonville-cleaning-32234`,
  keywords: ["Jacksonville Cleaning 32234 cleaning","Jacksonville Cleaning 32234 service","Jacksonville cleaning"],
});
