...
export const metadata: Metadata = buildMetadata({
  title: pageData?.title ?? 'Jacksonville Cleaning 32229',
  description: pageData?.description ?? 'Jacksonville cleaning service information.',
  canonical: `${SITE_CONFIG.url}/jacksonville-cleaning-32229`,
  keywords: ["Jacksonville Cleaning 32229 cleaning","Jacksonville Cleaning 32229 service","Jacksonville cleaning"],
});
