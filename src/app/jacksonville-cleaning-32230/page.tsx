...
export const metadata: Metadata = buildMetadata({
  title: pageData?.title ?? 'Jacksonville Cleaning 32230',
  description: pageData?.description ?? 'Jacksonville cleaning service information.',
  canonical: `${SITE_CONFIG.url}/jacksonville-cleaning-32230`,
  keywords: ["Jacksonville Cleaning 32230 cleaning","Jacksonville Cleaning 32230 service","Jacksonville cleaning"],
});
