...
export const metadata: Metadata = buildMetadata({
  title: pageData?.title ?? 'Jacksonville Cleaning 32252',
  description: pageData?.description ?? 'Jacksonville cleaning service information.',
  canonical: `${SITE_CONFIG.url}/jacksonville-cleaning-32252`,
  keywords: ["Jacksonville Cleaning 32252 cleaning","Jacksonville Cleaning 32252 service","Jacksonville cleaning"],
});
