...
export const metadata: Metadata = buildMetadata({
  title: pageData?.title ?? 'Jacksonville Cleaning 32218',
  description: pageData?.description ?? 'Jacksonville cleaning service information.',
  canonical: `${SITE_CONFIG.url}/jacksonville-cleaning-32218`,
  keywords: ["Jacksonville Cleaning 32218 cleaning","Jacksonville Cleaning 32218 service","Jacksonville cleaning"],
});
