  ...
  return (
    <div className="min-h-screen">
      <UniversalServiceHero 
        title="Jacksonville Service Areas Map Complete Coverage Across All Neighborhoods"
        subtitle="From Riverside to the Beaches, Mandarin to Arlington - we provide professional cleaning services across all of Jacksonville and surrounding areas."
        Icon={Sparkles}
        primaryColor="blue"
        formServiceType="service-areas-map"
      />
