...
export const metadata: Metadata = buildMetadata({
  title: pageData?.title ?? 'Jacksonville Cleaning 32226',
  description: pageData?.description ?? 'Jacksonville cleaning service information.',
  canonical: `${SITE_CONFIG.url}/jacksonville-cleaning-32226`,
  keywords: ["Jacksonville Cleaning 32226 cleaning","Jacksonville Cleaning 32226 service","Jacksonville cleaning"],
});
