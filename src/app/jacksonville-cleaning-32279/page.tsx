...
export const metadata: Metadata = buildMetadata({
  title: pageData?.title ?? 'Jacksonville Cleaning 32279',
  description: pageData?.description ?? 'Jacksonville cleaning service information.',
  canonical: `${SITE_CONFIG.url}/jacksonville-cleaning-32279`,
  keywords: ["Jacksonville Cleaning 32279 cleaning","Jacksonville Cleaning 32279 service","Jacksonville cleaning"],
});
