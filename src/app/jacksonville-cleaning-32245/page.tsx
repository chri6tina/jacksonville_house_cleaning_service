...
export const metadata: Metadata = buildMetadata({
  title: pageData?.title ?? 'Jacksonville Cleaning 32245',
  description: pageData?.description ?? 'Jacksonville cleaning service information.',
  canonical: `${SITE_CONFIG.url}/jacksonville-cleaning-32245`,
  keywords: ["Jacksonville Cleaning 32245 cleaning","Jacksonville Cleaning 32245 service","Jacksonville cleaning"],
});
