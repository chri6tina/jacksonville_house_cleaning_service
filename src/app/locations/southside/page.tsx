...
export const metadata: Metadata = generateLocationMetadata('southside', 'Family-Friendly Cleaning Service');

export default function SouthsidePage() {
  const popularServices = [
    {
      title: 'Family Home Cleaning',
      description: 'Reliable cleaning for Southside families',
      icon: Home,
  ...
  const localFeatures = [
    {
      ...
      description: 'Safe, family-friendly neighborhood with excellent schools and parks'
    },
    {
      icon: Users,
      title: 'Suburban Living',
      description: 'Professional cleaning for suburban homes and family residences'
    },
    {
      icon: Building2,
      title: 'Local Businesses',
      description: 'Supporting Southside\'s business community and professional offices'
    },
    {
      icon: Leaf,
      title: 'Green Spaces',
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      review: 'The Southside team is perfect for our busy family. They clean efficiently and use safe products for our kids and pets.',
      date: 'January 2024'
    },
    {
      name: 'Robert Chen',
      ...
      rating: 5,
      review: 'After hosting a large family gathering, we needed thorough cleaning. The Southside team exceeded expectations.',
      date: 'December 2023'
    },
    {
      name: 'Sarah Williams',
      ...
      rating: 5,
      review: 'When selling our Southside home, the move-out cleaning was perfect. Our realtor was impressed with the results.',
      date: 'November 2023'
    }
  ];
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "LocalBusiness",
            "name": "Jacksonville House Cleaning Service - Southside",
            "description": "Professional house cleaning services in Southside Jacksonville, FL. Family-friendly cleaning solutions for Southside homes with 45K+ residents served.",
            ...
            "address": {
              "@type": "PostalAddress",
              "streetAddress": "Southside Jacksonville",
      ...
      <div className="min-h-screen">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <div className="inline-flex items-center gap-2 bg-white/95 text-gray-800 px-6 py-3 rounded-full text-sm font-semibold mb-6 border border-white/50 shadow-lg">
                ...
                Serving Southside Jacksonville Since 2015
              </div>

              {/* Main Headline */}
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight text-white">
                <span className="block">Professional Cleaning</span>
                <span className="block text-cyan-400">in Southside</span>
                <span className="block text-lg sm:text-xl lg:text-2xl font-medium text-white/90 mt-3">
                  Jacksonville&apos;s Family-Friendly Cleaning Service
                </span>
              </h1>

              {/* Subtitle */}
              <p className="text-xl text-white/95 mb-10 max-w-4xl mx-auto leading-relaxed">
                We&apos;re your Southside Jacksonville neighbors, providing reliable, eco-friendly cleaning services 
                that understand family life. No corporate chains, just local professionals who care about your 
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:bg-white/15 transition-all duration-300 text-center">
                  ...
                  <p className="text-white/80 text-xs leading-relaxed">Southside neighbors</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <Breadcrumb 
              items={[
                ...
                { label: 'Southside', href: '/locations/southside', current: true }
              ]}
            />
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                  Welcome to Southside Jacksonville
                </h2>
                <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                  Southside is one of Jacksonville&apos;s most family-friendly communities, 
                  known for its excellent schools, beautiful parks, and safe suburban atmosphere. 
                  With a population of over 45,000 residents, Southside offers the perfect 
                  blend of family living and modern convenience.
                </p>
                <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                  Our Southside cleaning team understands the unique needs of this community - from 
                  family homes that need reliable maintenance to busy professionals who require flexible 
                  scheduling. We&apos;re proud to serve our neighbors with the same level of care 
                  and attention we&apos;d want for our own homes.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Whether you have a growing family or need reliable maintenance, 
                ...
                <div className="bg-gradient-to-br from-primary-blue/20 to-accent-aqua/20 rounded-2xl p-8">
                  <div className="text-center">
                    <div className="w-20 h-20 bg-primary-blue rounded-full flex items-center justify-center mx-auto mb-6">
                      <span className="text-white text-3xl font-bold">45K+</span>
                    </div>
                    <h3 className="text-2xl font-bold text-gray-900 mb-2">Southside Residents</h3>
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">Why Southside Loves Jacksonville House Cleaning Service</h2>
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                We understand Southside&apos;s unique characteristics and tailor our services to meet the specific needs of this family community.
              </p>
            </div>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">Popular Cleaning Services in Southside</h2>
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                From family home care to specialized deep cleaning, we offer comprehensive solutions 
                tailored to Southside&apos;s unique needs and your specific requirements.
              </p>
            </div>
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">Southside Service Areas</h2>
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                We serve all of Southside Jacksonville and surrounding areas. Check if your address is in our service zone.
              </p>
            </div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-gray-700">Southside Core</span>
                    <span className="font-semibold text-gray-900">32216</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-700">Southside East</span>
                    <span className="font-semibold text-gray-900">32256</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-700">Southside West</span>
                    <span className="font-semibold text-gray-900">32216</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-700">Southside South</span>
                    <span className="font-semibold text-gray-900">32256</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-semibold text-gray-900">32223, 32257</span>
                  </div>
                  <div className="flex items-center justify-between">
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">What Southside Residents Say</h2>
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                Don&apos;t just take our word for it. Here&apos;s what your Southside neighbors are saying about our cleaning services.
              </p>
            </div>
        ...
        <section className="py-20 bg-gradient-to-r from-primary-blue to-accent-aqua">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-4xl font-bold text-white mb-6">
              Ready for Professional Cleaning in Southside?
            </h2>
            <p className="text-xl text-white/90 mb-8">
              Join hundreds of satisfied Southside residents who trust us with their cleaning needs.
            </p>
