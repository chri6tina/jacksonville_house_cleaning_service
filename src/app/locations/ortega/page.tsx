...
export const metadata: Metadata = generateLocationMetadata('ortega', 'Waterfront Luxury Cleaning Service');

export default function OrtegaPage() {
  const popularServices = [
    {
      title: 'Luxury Home Cleaning',
      description: 'Premium cleaning for Ortega\'s waterfront estates',
      icon: Home,
      href: '/recurring-cleaning',
      features: ['Premium cleaning products', 'Attention to luxury finishes', 'White glove service', 'Discrete professional staff']
    },
    {
      title: 'Deep Cleaning',
  ...
  const localFeatures = [
    {
      ...
      description: 'Exclusive waterfront properties with stunning river views and boat access'
    },
    {
      icon: Users,
      title: 'Luxury Community',
      description: 'High-end residential area with discerning homeowners who expect excellence'
    },
    {
      icon: Building2,
      title: 'Estate Properties',
      description: 'Large luxury homes and estates requiring specialized cleaning attention'
    },
    {
      icon: Waves,
      title: 'River Access',
      description: 'Properties with St. Johns River access and waterfront amenities'
    }
  ];
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      review: 'The Ortega team provides exceptional service for our waterfront estate. They understand luxury homes and use the finest products.',
      date: 'January 2024'
    },
    {
      ...
      rating: 5,
      review: 'After hosting a charity gala, we needed immaculate cleaning. The Ortega team exceeded our high expectations completely.',
      date: 'December 2023'
    },
    {
      ...
      rating: 5,
      review: 'When selling our Ortega home, the cleaning team made it absolutely perfect for potential buyers. Outstanding service!',
      date: 'November 2023'
    }
  ];
  ...
  return (
    <>
      {/* LocalBusiness Schema for Ortega */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "LocalBusiness",
            "name": "Jacksonville House Cleaning Service - Ortega",
            "description": "Professional house cleaning services in Ortega, Jacksonville. Waterfront luxury cleaning with premium service and attention to detail.",
            "url": "https://jacksonvillehousecleaningservice.com/locations/ortega",
            "telephone": "+19044563851",
            "email": "info@jacksonvillehousecleaningservice.com",
            "address": {
              "@type": "PostalAddress",
              "streetAddress": "Ortega",
            ...
            "hasOfferCatalog": {
              "@type": "OfferCatalog",
              "name": "Ortega House Cleaning Services",
              "itemListElement": [
                {
                  "@type": "Offer",
                  "itemOffered": {
      ...
      <div className="min-h-screen">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight text-white">
                ...
                <span className="block text-cyan-400">in Ortega</span>
                <span className="block text-lg sm:text-xl lg:text-2xl font-medium text-white/90 mt-3">
                  Jacksonville&apos;s Waterfront Luxury Cleaning Service
                </span>
              </h1>

              {/* Subtitle */}
              <p className="text-xl text-white/95 mb-10 max-w-4xl mx-auto leading-relaxed">
                We&apos;re your Ortega Jacksonville neighbors, providing premium cleaning services 
                that understand luxury waterfront living. No corporate chains, just local professionals who care about 
                maintaining the pristine condition of your beautiful property.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:bg-white/15 transition-all duration-300 text-center">
                  ...
                  <p className="text-white/80 text-xs leading-relaxed">Ortega neighbors</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <Breadcrumb 
              items={[
                ...
                { label: 'Ortega', href: '/locations/ortega', current: true }
              ]}
            />
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                  Welcome to Ortega Jacksonville
                </h2>
                <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                  Ortega is one of Jacksonville&apos;s most prestigious waterfront communities, 
                  known for its stunning river views, luxury estates, and exclusive residential atmosphere. 
                  With a population of over 8,000 residents, Ortega offers the perfect 
                  blend of luxury living and natural beauty.
                </p>
                <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                  Our Ortega cleaning team understands the unique needs of luxury waterfront properties - from 
                  careful handling of premium finishes to using high-end cleaning products. 
                  We&apos;re proud to serve our neighbors with the same level of excellence 
                  and attention to detail they expect.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Whether you have a waterfront mansion or a luxury estate, 
                ...
                <div className="bg-gradient-to-br from-primary-blue/20 to-accent-aqua/20 rounded-2xl p-8">
                  <div className="text-center">
                    <div className="w-20 h-20 bg-primary-blue rounded-full flex items-center justify-center mx-auto mb-6">
                      <span className="text-white text-3xl font-bold">8K+</span>
                    </div>
                    <h3 className="text-2xl font-bold text-gray-900 mb-2">Ortega Residents</h3>
                    <p className="text-gray-700">Proud to serve our luxury community</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                Popular Services in Ortega
              </h2>
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                Our Ortega cleaning team specializes in luxury home care, offering premium services 
                designed to maintain the pristine condition of your waterfront property.
              </p>
            </div>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                Why Ortega Residents Choose Us
              </h2>
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                We understand the unique characteristics of Ortega and provide cleaning services 
                that respect the luxury nature of your waterfront property.
              </p>
            </div>
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                What Ortega Residents Say
              </h2>
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                Don&apos;t just take our word for it - hear from our satisfied Ortega customers.
              </p>
            </div>
        ...
        <section className="py-20 bg-primary-blue">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
              Ready for Professional Cleaning in Ortega?
            </h2>
            <p className="text-xl text-white/95 mb-10 max-w-3xl mx-auto">
              Join hundreds of satisfied Ortega residents who trust us with their luxury waterfront homes. 
