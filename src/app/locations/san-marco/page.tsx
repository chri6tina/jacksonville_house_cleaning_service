...
export default function SanMarcoPage() {
  const popularServices = [
    {
      ...
      description: 'Premium cleaning for upscale San Marco homes',
      icon: Home,
  ...
  const localFeatures = [
    ...
    },
    {
      ...
      description: 'Supporting San Marco\'s professional offices and commercial properties'
    },
    {
      icon: Leaf,
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      review: 'The San Marco team provides exceptional service for our luxury home. They understand the level of detail we expect.',
      date: 'January 2024'
    },
    {
      ...
      rating: 5,
      review: 'After hosting a corporate event, we needed thorough cleaning. The San Marco team exceeded expectations.',
      date: 'December 2023'
    },
    {
      name: 'Lisa Thompson',
      ...
      rating: 5,
      review: 'When selling our San Marco home, the move-out cleaning was perfect. Our realtor was impressed with the results.',
      date: 'November 2023'
    }
  ];
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "LocalBusiness",
            "name": "Jacksonville House Cleaning Service - San Marco",
            "description": "Professional house cleaning services in San Marco Jacksonville, FL. Upscale community cleaning solutions for San Marco homes with 18K+ residents served.",
            ...
            "address": {
              "@type": "PostalAddress",
              "streetAddress": "San Marco Jacksonville",
            ...
            "hasOfferCatalog": {
              "@type": "OfferCatalog",
              "name": "San Marco Jacksonville Cleaning Services",
      ...
      <div className="min-h-screen">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <div className="inline-flex items-center gap-2 bg-white/95 text-gray-800 px-6 py-3 rounded-full text-sm font-semibold mb-6 border border-white/50 shadow-lg">
                ...
                Serving San Marco Jacksonville Since 2015
              </div>

              {/* Main Headline */}
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight text-white">
                <span className="block">Professional Cleaning</span>
                <span className="block text-cyan-400">in San Marco</span>
              ...
              <p className="text-xl text-white/95 mb-10 max-w-4xl mx-auto leading-relaxed">
                We&apos;re your San Marco Jacksonville neighbors, providing premium, eco-friendly cleaning services 
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:bg-white/15 transition-all duration-300 text-center">
                  ...
                  <p className="text-white/80 text-xs leading-relaxed">San Marco neighbors</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                  Welcome to San Marco Jacksonville
                </h2>
                <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                  San Marco is one of Jacksonville&apos;s most prestigious and upscale communities, 
                  known for its beautiful luxury homes, waterfront properties, and professional atmosphere. 
                  With a population of over 18,000 residents, San Marco offers the perfect blend of 
                  sophisticated living and natural beauty.
                </p>
                <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                  Our San Marco cleaning team understands the unique needs of this community - from 
              ...
              <div className="relative">
                <div className="bg-gradient-to-br from-primary-blue/20 to-accent-aqua/20 rounded-2xl p-8">
                  <div className="text-center">
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mb-2">San Marco Residents</h3>
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">Why San Marco Loves Jacksonville House Cleaning Service</h2>
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                We understand San Marco&apos;s unique characteristics and tailor our services to meet the specific needs of this upscale community.
              </p>
            </div>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">Popular Cleaning Services in San Marco</h2>
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                From luxury home care to specialized deep cleaning, we offer comprehensive solutions 
                tailored to San Marco&apos;s unique needs and your specific requirements.
              </p>
            </div>
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">San Marco Service Areas</h2>
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                We serve all of San Marco Jacksonville and surrounding areas. Check if your address is in our service zone.
              </p>
            </div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-gray-700">San Marco Core</span>
                    <span className="font-semibold text-gray-900">32207</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-700">San Marco East</span>
                    <span className="font-semibold text-gray-900">32207</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-700">San Marco West</span>
                    <span className="font-semibold text-gray-900">32207</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-700">San Marco South</span>
                    <span className="font-semibold text-gray-900">32207</span>
                  </div>
                </div>
              </div>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">What San Marco Residents Say</h2>
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                Don&apos;t just take our word for it. Here&apos;s what your San Marco neighbors are saying about our cleaning services.
              </p>
            </div>
                ...
                <div key={index} className="bg-gray-50 rounded-xl p-6 hover:shadow-lg transition-shadow duration-300">
                  ...
                  <div className="border-t border-gray-200 pt-4">
                    ...
                    <div className="flex items-center space-x-2 text-sm text-gray-600">
                      ...
                      <span>San Marco, Jacksonville</span>
                    </div>
        ...
        <section className="py-20 bg-gradient-to-r from-primary-blue to-accent-aqua">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-4xl font-bold text-white mb-6">
              Ready for Professional Cleaning in San Marco?
            </h2>
            <p className="text-xl text-white/90 mb-8">
              Join hundreds of satisfied San Marco residents who trust us with their cleaning needs.
            </p>
