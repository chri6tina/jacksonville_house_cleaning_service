...
export default function SanMarcoPage() {
    ...
    residential: [
      {
        ...
        description: 'Weekly, bi-weekly, or monthly cleaning for San Marco homes',
      ...
      {
        name: 'Deep Cleaning',
        description: 'Comprehensive cleaning for San Marco homes needing extra attention',
      ...
      },
      {
        ...
        description: 'Thorough cleaning for San Marco property transitions',
    ...
    commercial: [
      {
        ...
        description: 'Professional cleaning for San Marco businesses and offices',
      ...
      },
      {
        ...
        description: 'Storefront and retail space cleaning in San Marco',
  ...
  const specialServices = [
    {
      ...
      description: 'Professional deep cleaning for San Marco homes with carpets',
      price: 'Starting at $155',
      icon: Car
    },
    {
      name: 'Window Cleaning',
      description: 'Interior and exterior window cleaning for San Marco homes',
      price: 'Starting at $125',
      icon: Wind
    },
    {
      name: 'Post-Construction Cleaning',
      description: 'Cleanup after renovations in San Marco homes',
      price: 'Starting at $255',
      icon: Hammer
    },
    {
      name: 'Kitchen Deep Cleaning',
      description: 'Intensive kitchen cleaning for San Marco homes',
      price: 'Starting at $185',
      icon: Droplets
    }
  ];
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section - San Marco Specific */}
      <section 
          ...
          <div className="text-center">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight text-white">
              ...
              <span className="block text-lg sm:text-xl lg:text-2xl font-medium text-white/90 mt-3">
                Your Local Cleaning Team in Elegant San Marco
              </span>
            </h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:bg-white/15 transition-all duration-300 text-center">
                ...
                <h3 className="font-bold text-white text-base mb-2">80+ San Marco Families</h3>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:bg-white/15 transition-all duration-300 text-center">
                ...
                <h3 className="font-bold text-white text-base mb-2">Local San Marco Team</h3>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:bg-white/15 transition-all duration-300 text-center">
                ...
                <h3 className="font-bold text-white text-base mb-2">5-Star San Marco Reviews</h3>
      ...
      {/* San Marco Neighborhood Info */}
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold text-charcoal mb-6">
                Why San Marco Chooses Our Cleaning Services
              </h2>
              <p className="text-lg text-charcoal/70 mb-6 leading-relaxed">
                San Marco is known for its elegant homes, upscale shopping, and sophisticated atmosphere. 
                We understand the premium standards expected in this prestigious neighborhood and deliver 
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-charcoal/80">Luxury home expertise</span>
                </div>
                <div className="flex items-center gap-3">
                  <Check className="w-5 h-5 text-accent-green" />
                  <span className="text-charcoal/80">Premium cleaning standards</span>
                </div>
                <div className="flex items-center gap-3">
                  <Check className="w-5 h-5 text-accent-green" />
                  <span className="text-charcoal/80">Discreet, professional service</span>
                </div>
                <div className="flex items-center gap-3">
                  <Check className="w-5 h-5 text-accent-green" />
                  <span className="text-charcoal/80">Eco-friendly premium products</span>
                </div>
              </div>
            </div>
            <div className="bg-gradient-to-br from-primary-blue/20 to-accent-aqua/20 rounded-2xl p-8">
              <div className="text-center">
                ...
                <h3 className="text-2xl font-bold text-charcoal mb-2">San Marco Service Area</h3>
                <p className="text-charcoal/70 mb-4">Covering all of San Marco and surrounding areas</p>
                <div className="space-y-2 text-sm text-charcoal/70">
                  <p>• San Marco Square</p>
                  <p>• San Marco Boulevard</p>
                  <p>• Balis Park</p>
                  <p>• Southbank</p>
                  <p>• St. Nicholas</p>
                </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-charcoal mb-6">
              San Marco Cleaning Services & Pricing
            </h2>
            <p className="text-xl text-charcoal/70 max-w-3xl mx-auto">
              Premium cleaning solutions tailored specifically for San Marco homes and businesses. 
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-charcoal mb-6">
              Specialized Cleaning Services in San Marco
            </h2>
            <p className="text-xl text-charcoal/70 max-w-3xl mx-auto">
              Additional services to keep your San Marco home or business in perfect condition
            </p>
          </div>
