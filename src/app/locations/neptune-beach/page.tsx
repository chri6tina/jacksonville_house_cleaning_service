...
import { Phone, MapPin, Star, Clock, Shield, CheckCircle, Sparkles, Home, Building2, Car, Droplets, Gauge, Calendar, GraduationCap, Users, Leaf, Zap, Target, Award, Waves, Umbrella, Anchor, Store } from 'lucide-react';
...
export default function NeptuneBeachPage() {
  const neptuneBeachServices = [
    {
      ...
      description: 'Regular maintenance cleaning designed for Neptune Beach cottages and coastal challenges',
      icon: Home,
    ...
    },
    {
      id: 'deep-cleaning',
      title: 'Deep Cleaning',
      description: 'Comprehensive cleaning service for thorough Neptune Beach home refreshment',
      icon: Sparkles,
    ...
    },
    {
      ...
      description: 'Complete cleaning service for smooth transitions in Neptune Beach',
      icon: Car,
    ...
    },
    {
      ...
      description: 'Consistent cleaning schedule to maintain your Neptune Beach home',
      icon: Calendar,
    ...
    },
    {
      ...
      description: 'Professional cleaning for Neptune Beach vacation rental properties',
      icon: Building2,
    ...
    },
    {
      ...
      description: 'Crystal clear windows for your Neptune Beach home',
      icon: Building2,
    ...
    },
    {
      ...
      description: 'Exterior surface cleaning for Neptune Beach coastal properties',
      icon: Zap,
    ...
    },
    {
      ...
      description: 'Maintain proper drainage with Neptune Beach coastal considerations',
      icon: Droplets,
    ...
    },
    {
      ...
      description: 'Specialized cleaning for Neptune Beach apartment residents',
      icon: Building2,
    ...
    },
    {
      ...
      description: 'Professional cleaning for Neptune Beach businesses and offices',
      icon: Building2,
    ...
    },
    {
      ...
      description: 'Pre and post-event cleaning for Neptune Beach venues',
      icon: Users,
    ...
    },
    {
      ...
      description: 'Compassionate cleaning services for seniors in Neptune Beach',
      icon: Users,
    ...
    },
    {
      ...
      description: 'Safe cleaning solutions for homes with pets in Neptune Beach',
      icon: Leaf,
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200 py-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-blue-900 mb-6">
            Professional Cleaning Services in Neptune Beach
          </h1>
          <p className="text-xl md:text-2xl text-blue-800 mb-8 max-w-4xl mx-auto">
            Trusted cleaning solutions for homes and businesses in Neptune Beach, Jacksonville. 
            Serving ZIP code 32266 with coastal expertise and local business support.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link
              href="/contact?location=neptune-beach"
      ...
      {/* Neptune Beach Overview Section */}
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Neptune Beach: A Charming Coastal Community with Unique Cleaning Needs
              </h2>
              <div className="space-y-4 text-lg text-gray-600 leading-relaxed">
                <p>
                  Neptune Beach, located along the Atlantic coast between Jacksonville Beach and Atlantic Beach, 
                  is a charming beach community known for its cozy cottages, local businesses, and tight-knit 
                  community atmosphere. With a population of over 7,000 residents, Neptune Beach offers a 
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">32266</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">7,000+ residents</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Beach cottages, local businesses, restaurants</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Neptune Beach-Specific Cleaning Challenges & Solutions
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Understanding and addressing the unique cleaning needs of Neptune Beach coastal properties
            </p>
          </div>
            ...
            <div className="bg-green-50 p-8 rounded-2xl">
              ...
              <ul className="space-y-2 text-green-700">
                <li className="flex items-center space-x-2">
                  ...
                  <span>Coastal surface preservation</span>
                </li>
                <li className="flex items-center space-x-2">
                  <CheckCircle className="w-5 h-5 text-green-600" />
      ...
      <section id="services" className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Comprehensive Cleaning Services in Neptune Beach
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Professional cleaning solutions designed specifically for Neptune Beach coastal properties and community needs
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {neptuneBeachServices.map((service, index) => {
                ...
                <div key={service.id} className="bg-white border border-gray-200 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                  ...
                  <div className="p-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <Link
                        href={`/contact?service=${service.id}&location=neptune-beach`}
      ...
      <section className="py-16 bg-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-blue-900 mb-6">
            Ready to Experience Professional Cleaning in Neptune Beach?
          </h2>
