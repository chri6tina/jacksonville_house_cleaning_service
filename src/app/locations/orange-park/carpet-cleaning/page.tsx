...
export default function OrangeParkCarpetCleaningPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200 py-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-blue-900 mb-6">
            Carpet Cleaning Services in Orange Park
          </h1>
          <p className="text-xl md:text-2xl text-blue-800 mb-8 max-w-4xl mx-auto">
            Professional carpet cleaning tailored for Orange Park homes and families. 
            Serving ZIP codes 32073 and 32065 with military family support and local expertise.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link
              href="/contact?service=carpet-cleaning&location=orange-park"
      ...
      {/* Orange Park Carpet Cleaning Overview */}
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Carpet Cleaning Tailored for Orange Park Homes
              </h2>
              <div className="space-y-4 text-lg text-gray-600 leading-relaxed">
                <p>
                  Orange Park&apos;s unique suburban character, with its mix of military families from NAS Jacksonville, 
                  medical professionals from the Orange Park Medical Center, and growing families, requires carpet 
                  cleaning services that understand local needs and schedules.
                </p>
                <p>
                  Our carpet cleaning service in Orange Park is designed specifically for the area&apos;s larger 
                  ...
                  and busy families need thorough carpet care.
                </p>
                <p>
                  With strong partnerships with local Orange Park businesses, schools, and community organizations, 
                  we provide carpet cleaning that supports the area&apos;s growth and prosperity while maintaining 
            ...
            <div className="bg-gray-100 rounded-2xl p-8">
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Carpet Care</h3>
                    <p className="text-gray-600">Deep cleaning, stain removal, protection</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Orange Park-Specific Carpet Cleaning Features */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Understanding and addressing the unique carpet cleaning needs of Orange Park properties
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-blue-50 p-8 rounded-2xl">
              ...
              <p className="text-blue-800 mb-4">
                ...
                who require flexible scheduling, emergency services, and reliable carpet cleaning.
              </p>
              <ul className="space-y-2 text-blue-700">
                ...
                <li className="flex items-center space-x-2">
                  <CheckCircle className="w-5 h-5 text-blue-600" />
                  <span>Emergency carpet cleaning when needed</span>
                </li>
                <li className="flex items-center space-x-2">
                  <CheckCircle className="w-5 h-5 text-blue-600" />
            ...
            <div className="bg-green-50 p-8 rounded-2xl">
              ...
              <p className="text-green-800 mb-4">
                ...
                multiple bathrooms, and family-focused living spaces that require thorough carpet cleaning.
              </p>
              <ul className="space-y-2 text-green-700">
                ...
                <li className="flex items-center space-x-2">
                  <CheckCircle className="w-5 h-5 text-green-600" />
                  <span>Multiple room carpet care</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      {/* Carpet Cleaning Process for Orange Park */}
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Our Carpet Cleaning Process in Orange Park
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              How we deliver exceptional carpet cleaning results for Orange Park residents
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                We evaluate your Orange Park property&apos;s specific carpet cleaning needs, considering 
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Develop a carpet cleaning plan tailored to your Orange Park home&apos;s layout, 
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Our local Orange Park team delivers exceptional, thorough carpet cleaning 
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              How our carpet cleaning service supports the Orange Park community
            </p>
          </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Quick response times for urgent carpet cleaning needs in Orange Park</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-blue-900 mb-6">
            Ready for Professional Carpet Cleaning in Orange Park?
          </h2>
          <p className="text-xl text-blue-800 mb-8 max-w-3xl mx-auto">
            Join hundreds of satisfied Orange Park residents who trust us with their carpet cleaning needs. 
