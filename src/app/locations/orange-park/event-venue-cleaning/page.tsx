...
export default function OrangeParkEventVenueCleaningPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200 py-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-blue-900 mb-6">
            Event Venue Cleaning Services in Orange Park
          </h1>
          <p className="text-xl md:text-2xl text-blue-800 mb-8 max-w-4xl mx-auto">
            Professional event venue cleaning tailored for Orange Park venues and event spaces. 
            Serving ZIP codes 32073 and 32065 with military family support and local expertise.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link
              href="/contact?service=event-venue-cleaning&location=orange-park"
      ...
      {/* Orange Park Event Venue Cleaning Overview */}
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Event Venue Cleaning Tailored for Orange Park Venues
              </h2>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Event venues, community centers, military support venues</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Community centers, event halls, conference rooms, outdoor venues</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Event Care</h3>
                    <p className="text-gray-600">Pre-event preparation, post-event cleanup, quick turnaround</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Orange Park-Specific Event Venue Cleaning Features */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Understanding and addressing the unique event venue cleaning needs of Orange Park venues
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-blue-50 p-8 rounded-2xl">
              <h3 className="text-2xl font-bold text-blue-900 mb-4">Military Community Support</h3>
              <p className="text-blue-800 mb-4">
                With NAS Jacksonville nearby, we understand the unique needs of military community events 
                and venues that require flexible scheduling and reliable cleaning services.
              </p>
              <ul className="space-y-2 text-blue-700">
                <li className="flex items-center space-x-2">
                  <CheckCircle className="w-5 h-5 text-blue-600" />
                  <span>Military event venue expertise</span>
                </li>
                <li className="flex items-center space-x-2">
                  <CheckCircle className="w-5 h-5 text-blue-600" />
                  <span>Flexible scheduling for military events</span>
                </li>
                <li className="flex items-center space-x-2">
                  <CheckCircle className="w-5 h-5 text-blue-600" />
                  <span>Special rates for military community</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-green-50 p-8 rounded-2xl">
              ...
              <ul className="space-y-2 text-green-700">
                <li className="flex items-center space-x-2">
                  ...
                  <span>Community center cleaning protocols</span>
                </li>
                <li className="flex items-center space-x-2">
                  <CheckCircle className="w-5 h-5 text-green-600" />
                  <span>Quick turnaround for busy venues</span>
                </li>
                <li className="flex items-center space-x-2">
                  <CheckCircle className="w-5 h-5 text-green-600" />
                  <span>Local event schedule coordination</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      {/* Event Venue Cleaning Process for Orange Park */}
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Our Event Venue Cleaning Process in Orange Park
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              How we deliver exceptional event venue cleaning results for Orange Park venues
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Our local Orange Park team delivers exceptional, thorough event venue cleaning 
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              How our event venue cleaning service supports the Orange Park community
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Local Event Benefits</h3>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">Military Community Support</h4>
                    <p className="text-gray-600">Specialized cleaning for military events and venues in Orange Park</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Strong relationships with Orange Park venues and organizations</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
      ...
      <section className="py-16 bg-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-blue-900 mb-6">
            Ready for Professional Event Venue Cleaning in Orange Park?
          </h2>
          <p className="text-xl text-blue-800 mb-8 max-w-3xl mx-auto">
            Join hundreds of satisfied Orange Park event venues who trust us with their cleaning needs. 
