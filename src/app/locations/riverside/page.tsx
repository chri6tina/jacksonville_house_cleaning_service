...
export default function RiversidePage() {
    ...
    residential: [
      {
        ...
        description: 'Weekly, bi-weekly, or monthly cleaning for Riverside homes',
      ...
      {
        name: 'Deep Cleaning',
        description: 'Comprehensive cleaning for Riverside homes needing extra attention',
      ...
      },
      {
        ...
        description: 'Thorough cleaning for Riverside property transitions',
    ...
    commercial: [
      {
        ...
        description: 'Professional cleaning for Riverside businesses and offices',
      ...
      },
      {
        ...
        description: 'Storefront and retail space cleaning in Riverside',
  ...
  const specialServices = [
    {
      ...
      description: 'Professional deep cleaning for Riverside homes with carpets',
      price: 'Starting at $150',
      icon: Car
    },
    {
      name: 'Window Cleaning',
      description: 'Interior and exterior window cleaning for Riverside homes',
    ...
    },
    {
      ...
      description: 'Intensive kitchen cleaning for Riverside homes',
      price: 'Starting at $180',
      icon: Droplets
    }
  ];
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section - Riverside Specific */}
      <section 
          ...
          <div className="text-center">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight text-white">
              ...
              <span className="block text-lg sm:text-xl lg:text-2xl font-medium text-white/90 mt-3">
                Your Local Cleaning Team in Historic Riverside
              </span>
            </h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:bg-white/15 transition-all duration-300 text-center">
                ...
                <h3 className="font-bold text-white text-base mb-2">100+ Riverside Families</h3>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:bg-white/15 transition-all duration-300 text-center">
                ...
                <h3 className="font-bold text-white text-base mb-2">Local Riverside Team</h3>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:bg-white/15 transition-all duration-300 text-center">
                ...
                <h3 className="font-bold text-white text-base mb-2">5-Star Riverside Reviews</h3>
