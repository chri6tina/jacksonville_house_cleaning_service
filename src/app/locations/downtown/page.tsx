  ...
  const popularServices = [
    {
      ...
      description: 'Professional cleaning for Downtown offices and businesses',
      icon: Building2,
      href: '/recurring-cleaning',
      features: ['Business hours flexibility', 'Professional standards', 'Attention to detail', 'Reliable scheduling']
    },
    {
      title: 'Deep Cleaning',
  ...
  const localFeatures = [
    {
      ...
      description: 'Professional cleaning services for Downtown offices and commercial properties'
    },
    {
      icon: Users,
      title: 'Professional Community',
      description: 'High-quality cleaning for executives and business professionals'
    },
    {
      icon: Building2,
      title: 'Commercial Properties',
      description: 'Supporting Downtown\'s office buildings and retail spaces'
    },
    {
      icon: Leaf,
      title: 'Urban Living',
      description: 'Modern apartments and condos with city convenience'
    }
  ];
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      review: 'The Downtown team provides exceptional service for our medical office. They understand our professional standards.',
      date: 'January 2024'
    },
    {
      ...
      rating: 5,
      review: 'After hosting a corporate event, we needed thorough cleaning. The Downtown team exceeded expectations.',
      date: 'December 2023'
    },
    {
      name: 'Lisa Thompson',
      ...
      rating: 5,
      review: 'When selling our Downtown condo, the move-out cleaning was perfect. Our realtor was impressed with the results.',
      date: 'November 2023'
    }
  ];
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "LocalBusiness",
            "name": "Jacksonville House Cleaning Service - Downtown",
            "description": "Professional house cleaning services in Downtown Jacksonville, FL. Business district cleaning solutions for Downtown offices and residences with 15K+ residents served.",
            "url": "https://www.jacksonvillehousecleaningservice.com/locations/downtown",
            "telephone": "+19044563851",
            "email": "info@jacksonvillehousecleaningservice.com",
            "address": {
              "@type": "PostalAddress",
              "streetAddress": "Downtown Jacksonville",
      ...
      <div className="min-h-screen">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <div className="inline-flex items-center gap-2 bg-white/95 text-gray-800 px-6 py-3 rounded-full text-sm font-semibold mb-6 border border-white/50 shadow-lg">
                ...
                Serving Downtown Jacksonville Since 2015
              </div>

              {/* Main Headline */}
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight text-white">
                <span className="block">Professional Cleaning</span>
                <span className="block text-cyan-400">in Downtown</span>
                <span className="block text-lg sm:text-xl lg:text-2xl font-medium text-white/90 mt-3">
                  Jacksonville&apos;s Business District Cleaning Service
                </span>
              </h1>

              {/* Subtitle */}
              <p className="text-xl text-white/95 mb-10 max-w-4xl mx-auto leading-relaxed">
                We&apos;re your Downtown Jacksonville neighbors, providing reliable, eco-friendly cleaning services 
                that understand business needs and urban living. No corporate chains, just local professionals who care about your 
                space like it&apos;s our own.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:bg-white/15 transition-all duration-300 text-center">
                  ...
                  <p className="text-white/80 text-xs leading-relaxed">Downtown neighbors</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                  Downtown Jacksonville is the heart of our city&apos;s business and cultural community, 
                  known for its modern office buildings, professional services, and urban atmosphere. 
                  With a population of over 15,000 residents and countless businesses, Downtown offers 
                  the perfect blend of professional opportunity and city living.
                </p>
                <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                  Our Downtown cleaning team understands the unique needs of this community - from 
                  professional offices that require business-hour flexibility to urban residences that need reliable 
                  maintenance. We&apos;re proud to serve our neighbors with the same level of care 
                  and attention we&apos;d want for our own spaces.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Whether you work in a Downtown office or live in an urban residence, 
              ...
              <div className="relative">
                <div className="bg-gradient-to-br from-primary-blue/20 to-accent-aqua/20 rounded-2xl p-8">
                  <div className="text-center">
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mb-2">Downtown Residents</h3>
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">Why Downtown Loves Jacksonville House Cleaning Service</h2>
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                We understand Downtown&apos;s unique characteristics and tailor our services to meet the specific needs of this business community.
              </p>
            </div>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">Popular Cleaning Services in Downtown</h2>
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                From business cleaning to specialized deep cleaning, we offer comprehensive solutions 
                tailored to Downtown&apos;s unique needs and your specific requirements.
              </p>
            </div>
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">Downtown Service Areas</h2>
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                We serve all of Downtown Jacksonville and surrounding areas. Check if your address is in our service zone.
              </p>
            </div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-gray-700">Downtown Core</span>
                    <span className="font-semibold text-gray-900">32202</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-700">Downtown East</span>
                    <span className="font-semibold text-gray-900">32204</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-700">Downtown West</span>
                    <span className="font-semibold text-gray-900">32202</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-700">Downtown South</span>
                    <span className="font-semibold text-gray-900">32204</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-semibold text-gray-900">32211, 32225</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">What Downtown Residents Say</h2>
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                Don&apos;t just take our word for it. Here&apos;s what your Downtown neighbors are saying about our cleaning services.
              </p>
            </div>
        ...
        <section className="py-20 bg-gradient-to-r from-primary-blue to-accent-aqua">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-4xl font-bold text-white mb-6">
              Ready for Professional Cleaning in Downtown?
            </h2>
            <p className="text-xl text-white/90 mb-8">
              Join hundreds of satisfied Downtown residents who trust us with their cleaning needs.
            </p>
