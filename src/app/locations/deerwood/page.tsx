...
export default function DeerwoodPage() {
  const services = [
  ...
  const benefits = [
    ...
    },
    {
      icon: Star,
      title: '5-Star Rated',
      description: 'Trusted by Deerwood families'
    },
    {
      icon: Clock,
  ...
  const communityFeatures = [
    ...
    'Professional & executive residents'
  ];
  ...
  const landmarks = [
    ...
    'Deerwood Park',
    'Deerwood Shopping Center',
    'Deerwood Medical Center',
    'Deerwood Executive Park'
  ];
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-white mb-8 max-w-3xl mx-auto leading-relaxed drop-shadow-md">
              Professional cleaning services for Deerwood homes and businesses. 
              Serving this prestigious Jacksonville neighborhood with reliable, quality cleaning solutions.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                Deerwood Cleaning Services
              </h2>
              <p className="text-xl text-gray-700 mb-8 leading-relaxed">
                Our Deerwood cleaning team provides comprehensive cleaning services tailored to this 
                upscale Jacksonville neighborhood. From regular maintenance to deep cleaning, 
                we maintain the high standards Deerwood residents expect.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  <Check className="w-6 h-6 text-primary-blue mr-3" />
                  <span className="text-gray-900 font-medium">Local Deerwood team</span>
                </div>
                <div className="flex items-center">
                  <Check className="w-6 h-6 text-primary-blue mr-3" />
            ...
            <div className="bg-gradient-to-br from-primary-blue/5 to-accent-aqua/5 rounded-2xl p-8 border border-primary-blue/10">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Why Choose Us for Deerwood?</h3>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">We understand Deerwood homes and standards</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">Upscale Standards</h4>
                    <p className="text-gray-600 text-sm">Premium cleaning for premium homes</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
              Complete Cleaning Services for Deerwood
            </h2>
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              From routine maintenance to specialized cleaning, we cover all your Deerwood cleaning needs
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service, index) => (
              <div key={index} className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300 text-center">
                ...
                <p className="text-gray-600 text-sm">Professional service for Deerwood homes</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                Why Deerwood Residents Choose Us
              </h2>
              <p className="text-xl text-gray-700 mb-8 leading-relaxed">
                Deerwood is known for its upscale atmosphere and golf course community. 
                We understand the unique needs of this prestigious neighborhood and provide cleaning services 
                that match the high standards Deerwood residents expect.
              </p>
            ...
            <div className="bg-gradient-to-br from-accent-aqua/5 to-primary-blue/5 rounded-2xl p-8 border border-accent-aqua/10">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Deerwood Community Highlights</h3>
              <div className="space-y-4">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
              Deerwood Cleaning Pricing
            </h2>
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              Competitive rates for quality cleaning services in the Deerwood area
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 text-center">
              ...
              <p className="text-gray-700 mb-4">Regular maintenance cleaning for Deerwood homes</p>
              <div className="text-primary-blue font-bold text-lg">Starting at $140</div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-primary-blue text-center">
              ...
              <p className="text-gray-700 mb-4">Comprehensive cleaning for Deerwood residences</p>
              <div className="text-primary-blue font-bold text-lg">Starting at $220</div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 text-center">
              ...
              <p className="text-gray-700 mb-4">Complete cleaning for Deerwood transitions</p>
              <div className="text-primary-blue font-bold text-lg">Starting at $280</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
              Why Deerwood Residents Trust Us
            </h2>
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              We've built our reputation in Deerwood through consistent quality and reliable service
            </p>
          </div>
      ...
      <section className="py-20 bg-blue-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
            Ready for Professional Cleaning in Deerwood?
          </h2>
          <p className="text-xl text-gray-700 mb-8 max-w-3xl mx-auto">
            Contact us today for a free Deerwood cleaning quote and experience the difference 
