...
export const metadata: Metadata = buildMetadata({
  title: pageData?.title ?? 'Jacksonville Cleaning 32205',
  description: pageData?.description ?? 'Jacksonville cleaning service information.',
  canonical: `${SITE_CONFIG.url}/jacksonville-cleaning-32205`,
  keywords: ["Jacksonville Cleaning 32205 cleaning","Jacksonville Cleaning 32205 service","Jacksonville cleaning"],
});
