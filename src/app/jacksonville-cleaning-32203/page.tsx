...
export const metadata: Metadata = buildMetadata({
  title: pageData?.title ?? 'Jacksonville Cleaning 32203',
  description: pageData?.description ?? 'Jacksonville cleaning service information.',
  canonical: `${SITE_CONFIG.url}/jacksonville-cleaning-32203`,
  keywords: ["Jacksonville Cleaning 32203 cleaning","Jacksonville Cleaning 32203 service","Jacksonville cleaning"],
});
