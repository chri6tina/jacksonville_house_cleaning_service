  ...
  return (
    <div className="min-h-screen bg-white">
      <UniversalServiceHero 
        ...
        subtitle="Restore your Jacksonville carpets to their original beauty with our advanced cleaning technology"
        Icon={Sparkles}
        primaryColor="blue"
        formServiceType="carpet-cleaning"
      />
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl shadow-lg border-2 border-blue-200 p-8 hover:shadow-xl transition-all duration-300">
              <div className="text-center mb-6">
                <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Car className="w-8 h-8 text-primary-blue" />
                </div>
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Room Cleaning</h3>
                <div className="text-3xl font-bold text-primary-blue mb-2">From $50</div>
            ...
            <div className="bg-white rounded-2xl shadow-lg border-2 border-blue-200 p-8 hover:shadow-xl transition-all duration-300">
              <div className="text-center mb-6">
                ...
                <div className="text-3xl font-bold text-primary-blue mb-2">From $150</div>
            ...
            <div className="bg-white rounded-2xl shadow-lg border-2 border-blue-200 p-8 hover:shadow-xl transition-all duration-300">
              <div className="text-center mb-6">
                ...
                <div className="text-3xl font-bold text-primary-blue mb-2">From $200</div>
