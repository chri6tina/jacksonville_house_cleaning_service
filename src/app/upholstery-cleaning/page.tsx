  ...
  return (
    <div className="min-h-screen">
      ...
      <UniversalServiceHero 
        title="Professional Upholstery & Furniture Cleaning"
        subtitle="Expert cleaning for sofas, chairs, mattresses, and rugs. Safe for all fabric types with professional results."
        Icon={Sparkles}
        primaryColor="blue"
        formServiceType="upholstery-cleaning"
      />
