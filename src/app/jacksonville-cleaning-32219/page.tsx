...
export const metadata: Metadata = buildMetadata({
  title: pageData?.title ?? 'Jacksonville Cleaning 32219',
  description: pageData?.description ?? 'Jacksonville cleaning service information.',
  canonical: `${SITE_CONFIG.url}/jacksonville-cleaning-32219`,
  keywords: ["Jacksonville Cleaning 32219 cleaning","Jacksonville Cleaning 32219 service","Jacksonville cleaning"],
});
