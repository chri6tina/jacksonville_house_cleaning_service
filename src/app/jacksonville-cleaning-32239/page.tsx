...
export const metadata: Metadata = buildMetadata({
  title: pageData?.title ?? 'Jacksonville Cleaning 32239',
  description: pageData?.description ?? 'Jacksonville cleaning service information.',
  canonical: `${SITE_CONFIG.url}/jacksonville-cleaning-32239`,
  keywords: ["Jacksonville Cleaning 32239 cleaning","Jacksonville Cleaning 32239 service","Jacksonville cleaning"],
});
