  ...
  return (
    <div className="min-h-screen">
      ...
      <UniversalServiceHero 
        title="Professional Laundry & Ironing Services"
        subtitle="Convenient pickup, professional washing, expert ironing, and reliable delivery throughout Jacksonville"
        Icon={Sparkles}
        primaryColor="blue"
        formServiceType="laundry-services"
      />
