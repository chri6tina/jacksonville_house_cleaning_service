...
export const metadata: Metadata = buildMetadata({
  title: pageData?.title ?? 'Jacksonville Cleaning 32227',
  description: pageData?.description ?? 'Jacksonville cleaning service information.',
  canonical: `${SITE_CONFIG.url}/jacksonville-cleaning-32227`,
  keywords: ["Jacksonville Cleaning 32227 cleaning","Jacksonville Cleaning 32227 service","Jacksonville cleaning"],
});
