...
export const metadata: Metadata = buildMetadata({
  title: pageData?.title ?? 'Jacksonville Cleaning 32092',
  description: pageData?.description ?? 'Jacksonville cleaning service information.',
  canonical: `${SITE_CONFIG.url}/jacksonville-cleaning-32092`,
  keywords: ["Jacksonville Cleaning 32092 cleaning","Jacksonville Cleaning 32092 service","Jacksonville cleaning"],
});
