...
export const metadata: Metadata = buildMetadata({
  ...
  description: pageData?.description ?? 'Cleaning services for St. Augustine.',
  canonical: `${SITE_CONFIG.url}/st-augustine-cleaning`,
  keywords: ['St. Augustine cleaning', 'St. Augustine house cleaning', 'cleaning services St. Augustine'],
});
