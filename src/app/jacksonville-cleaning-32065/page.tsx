...
export const metadata: Metadata = buildMetadata({
  title: pageData?.title ?? 'Jacksonville Cleaning 32065',
  description: pageData?.description ?? 'Jacksonville cleaning service information.',
  canonical: `${SITE_CONFIG.url}/jacksonville-cleaning-32065`,
  keywords: ["Jacksonville Cleaning 32065 cleaning","Jacksonville Cleaning 32065 service","Jacksonville cleaning"],
});
