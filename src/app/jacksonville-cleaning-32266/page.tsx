...
export const metadata: Metadata = buildMetadata({
  title: pageData?.title ?? 'Jacksonville Cleaning 32266',
  description: pageData?.description ?? 'Jacksonville cleaning service information.',
  canonical: `${SITE_CONFIG.url}/jacksonville-cleaning-32266`,
  keywords: ["Jacksonville Cleaning 32266 cleaning","Jacksonville Cleaning 32266 service","Jacksonville cleaning"],
});
