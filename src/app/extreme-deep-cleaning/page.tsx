...
export default function ExtremeDeepCleaningPage() {
  ...
  return (
    <>
      {/* Structured Data for Extreme Deep Cleaning Service */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            "name": "Jacksonville Extreme Deep Cleaning Services",
            "description": "Professional extreme deep cleaning services in Jacksonville, FL. Comprehensive home restoration, move-out cleaning, and hoarder cleanup with same-day service available.",
            "provider": {
              "@type": "Organization",
            ...
            "serviceType": "Extreme Deep Cleaning",
            ...
            "hasOfferCatalog": {
              "@type": "OfferCatalog",
              "name": "Jacksonville Extreme Deep Cleaning Options",
