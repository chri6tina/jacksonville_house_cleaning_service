  ...
  return (
    <div className="min-h-screen bg-white">
      <UniversalServiceHero 
        ...
        subtitle="Protect your Jacksonville home from water damage with our professional gutter cleaning services. Clean gutters prevent foundation issues and protect your investment."
        Icon={Sparkles}
        primaryColor="blue"
        formServiceType="gutter-cleaning"
      />
