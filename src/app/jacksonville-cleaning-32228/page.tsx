...
export const metadata: Metadata = buildMetadata({
  title: pageData?.title ?? 'Jacksonville Cleaning 32228',
  description: pageData?.description ?? 'Jacksonville cleaning service information.',
  canonical: `${SITE_CONFIG.url}/jacksonville-cleaning-32228`,
  keywords: ["Jacksonville Cleaning 32228 cleaning","Jacksonville Cleaning 32228 service","Jacksonville cleaning"],
});
