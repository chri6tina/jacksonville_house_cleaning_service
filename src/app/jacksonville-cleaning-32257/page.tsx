...
export const metadata: Metadata = buildMetadata({
  title: pageData?.title ?? 'Jacksonville Cleaning 32257',
  description: pageData?.description ?? 'Jacksonville cleaning service information.',
  canonical: `${SITE_CONFIG.url}/jacksonville-cleaning-32257`,
  keywords: ["Jacksonville Cleaning 32257 cleaning","Jacksonville Cleaning 32257 service","Jacksonville cleaning"],
});
