...
export const metadata: Metadata = buildMetadata({
  title: pageData?.title ?? 'Jacksonville Cleaning 32261',
  description: pageData?.description ?? 'Jacksonville cleaning service information.',
  canonical: `${SITE_CONFIG.url}/jacksonville-cleaning-32261`,
  keywords: ["Jacksonville Cleaning 32261 cleaning","Jacksonville Cleaning 32261 service","Jacksonville cleaning"],
});
