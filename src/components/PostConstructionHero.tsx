      ...
      if (response.ok) {
        ...
        if (typeof window !== 'undefined' && (window as any).dataLayer) {
          (window as any).dataLayer.push({
            event: 'form_submit',
            form_type: 'post_construction_hero',
  ...
  return (
    <div className="relative bg-blue-600 text-white min-h-screen flex items-center">
      ...
      <div className="absolute inset-0">
        <img
          src="/post-construction-hero.jpg"
          alt="Post-construction cleanup in Jacksonville, FL"
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold mb-4 md:mb-6 leading-tight">
              Jacksonville's #1 Post-Construction Cleanup
            </h1>
            
            <p className="text-lg sm:text-xl lg:text-2xl mb-6 md:mb-8 text-blue-100 leading-relaxed">
              Professional debris removal and final cleaning for new builds and renovations
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4 text-sm">
              <div className="bg-white/20 p-3 md:p-4 rounded-lg">
                ...
                <div className="text-blue-100 text-xs md:text-sm">Full coverage protection</div>
              </div>
              <div className="bg-white/20 p-3 md:p-4 rounded-lg">
                <div className="font-bold mb-1">✓ Same-Day Service</div>
                <div className="text-blue-100 text-xs md:text-sm">Quick turnaround</div>
              </div>
              <div className="bg-white/20 p-3 md:p-4 rounded-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-3 md:space-y-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Complete Post-Construction Cleanup">Complete Post-Construction Cleanup</option>
                    <option value="Debris Removal Only">Debris Removal Only</option>
                    <option value="Final Detail Cleaning">Final Detail Cleaning</option>
                    <option value="New Construction Cleanup">New Construction Cleanup</option>
                  </select>
                </div>
