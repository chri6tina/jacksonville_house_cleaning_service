...
export default function PostConstructionHeroVariantB() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await submitToFormspree(
        {
          source: 'Post Construction Hero Variant B',
          name: formData.name,
        ...
        'New Post-Construction Quote Request - Variant B'
      );

      if (typeof window !== 'undefined' && (window as any).dataLayer) {
        (window as any).dataLayer.push({
          event: 'hero_form_submit',
          form_type: 'post_construction_hero_variant_b'
        });
      }
  ...
  const handleCallClick = () => {
    if (typeof window !== 'undefined' && (window as any).dataLayer) {
      (window as any).dataLayer.push({
        ...
        button_location: 'hero_primary_variant_b'
      });
    }
  };
  ...
  const handleQuoteClick = () => {
    if (typeof window !== 'undefined' && (window as any).dataLayer) {
      (window as any).dataLayer.push({
        ...
        button_location: 'hero_secondary_variant_b'
      });
    }
    scrollToForm();
  };
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "We haul the debris and do the final clean. One team, one schedule, spotless hand-off for Jacksonville post-construction cleanup.",
            ...
            "hasOfferCatalog": {
              "@type": "OfferCatalog",
              "name": "Jacksonville Combined Post-Construction Services",
              "itemListElement": [
                {
                  "@type": "Offer",
                  "itemOffered": {
                    "@type": "Service",
                    "name": "Combined Debris Removal & Final Cleaning",
                    "description": "One team handles everything from debris hauling to spotless hand-off"
                  }
                },
                {
                  "@type": "Offer",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="inline-flex items-center gap-2 bg-cyan-100 border border-cyan-200 px-4 py-2 rounded-full text-sm font-medium text-cyan-800 mb-6">
                ...
                <span>One Team, Complete Service</span>
              </div>

              {/* Main Headline - VARIANT B */}
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                We Haul the Debris and{' '}
                <span className="text-cyan-600">Do the Final Clean</span>
              </h1>

              {/* Supporting Line - VARIANT B */}
              <p className="text-xl lg:text-2xl text-gray-700 mb-8 max-w-2xl lg:max-w-none">
                One team, one schedule, spotless hand-off.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8">
                <button
                  ...
                  aria-label="Get instant quote for combined debris removal and final cleaning"
                >
                ...
                <a
                  ...
                  aria-label="Call 904-456-3851 for immediate combined service"
                >
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 text-sm">
                ...
                <div className="flex items-center gap-3 bg-white px-4 py-3 rounded-xl border border-gray-200 shadow-sm">
                  ...
                  <span className="text-gray-800 font-medium">Debris + Cleaning</span>
                </div>
                <div className="flex items-center gap-3 bg-white px-4 py-3 rounded-xl border border-gray-200 shadow-sm">
                  <div className="w-6 h-6 bg-cyan-100 rounded-lg flex items-center justify-center">
                ...
                {!isSubmitted ? (
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="text-center mb-6">
                      <h2 className="text-2xl font-bold text-gray-900 mb-2">Get Your Combined Service Quote</h2>
                      <p className="text-gray-600">5-minute estimate, complete solution</p>
                    </div>
                    ...
                    <button
                      ...
                      aria-label="Submit quote request for combined debris removal and final cleaning"
                    >
                      {isSubmitting ? (
