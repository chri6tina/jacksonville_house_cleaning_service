      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-8 items-center justify-between">
          ...
          <div className="text-center lg:text-left lg:max-w-2xl">
            ...
            <div className="inline-flex items-center gap-2 bg-white/95 text-gray-800 px-4 sm:px-6 py-2 sm:py-3 rounded-full text-xs sm:text-sm font-semibold mb-6 sm:mb-8 border border-white shadow-lg mx-auto lg:mx-0">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight text-white drop-shadow-lg">
              ...
              <span className="block text-xl sm:text-2xl lg:text-3xl font-medium text-white mt-4 drop-shadow-md">
                in Jacksonville, FL
              </span>
            </h1>
            
            {/* Subtitle with local focus */}
            <p className="text-lg sm:text-xl md:text-2xl text-white mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed drop-shadow-md font-medium">
              Reliable, eco-friendly cleaning services for your home or office. No corporate chains, just local professionals who care.
            </p>
            
            {/* Quick Action Bar / Trust badges */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8 max-w-xl mx-auto lg:mx-0">
              <div className="flex items-center justify-center lg:justify-start gap-3 text-white text-lg font-semibold bg-white/10 px-4 py-3 rounded-xl border border-white/20">
              ...
              <div className="flex items-center justify-center lg:justify-start gap-3 text-white text-lg font-semibold bg-white/10 px-4 py-3 rounded-xl border border-white/20">
                <Leaf className="w-5 h-5 text-accent-aqua" />
            ...
            <div className="hidden lg:block">
              <Link 
                ...
                className="inline-flex items-center gap-3 text-white hover:text-cyan-300 transition-colors font-bold text-xl"
              >
